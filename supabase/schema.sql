...
VALUES
  ...
  ('Adept', 6, 'Mastering advanced concepts', 1500, ''),
  ('Master', 7, 'Expert in specific domains', 2500, ''),
  ('Expert', 8, 'Highly proficient across domains', 4000, ''),
  ('Grandmaster', 9, 'Elite level of expertise', 6000, ''),
  ('Star Rank', 10, 'Legendary status', 10000, '');
...
VALUES
  ...
  ('CS301', 'Data Structures and Algorithms', 'Explore fundamental data structures and algorithms', 5),
  ('CS401', 'Advanced Topics in Computer Science', 'Dive into specialized areas of computer science', 7);

-- Insert sample levels for CS101
INSERT INTO public.levels (course_id, level_number, title, description, points)
VALUES
  ((SELECT id FROM public.courses WHERE code = 'CS101'), 1, 'Introduction to Computing', 'Understand what computers are and how they work', 50),
  ((SELECT id FROM public.courses WHERE code = 'CS101'), 2, 'Variables and Data Types', 'Learn about different types of data and how to store them', 50),
  ((SELECT id FROM public.courses WHERE code = 'CS101'), 3, 'Control Structures', 'Master if statements and loops', 75),
  ((SELECT id FROM public.courses WHERE code = 'CS101'), 4, 'Functions', 'Learn to create reusable blocks of code', 75);
...
VALUES
  ...
  ('Data Scientist', 'Analyze and interpret complex data', ARRAY['Programming Basics', 'Algorithms', 'Data Structures'], 6, '$90,000 - $160,000');
